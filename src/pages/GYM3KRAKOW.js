...
import styles from "./GYM3KRAKOW.module.css";
...
const GYM3KRAKOW = () => {
  ...
  return (
    <>
      <div className={styles.gym3Krakow}>
        ...
        />
        <div className={styles.localizationBackgroun} />
        ...
        <div className={styles.gym3}>
          <img
            className={styles.gym3BackgroundIcon}
            alt=""
            src="../gym3-background@2x.png"
          />
          <Button
