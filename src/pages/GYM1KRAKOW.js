...
import styles from "./GYM1KRAKOW.module.css";
...
const GYM1KRAKOW = () => {
  ...
  return (
    <>
      <div className={styles.gym1Krakow}>
        ...
        />
        <div className={styles.gym1localization} />
        <div className={styles.localization}>Localization</div>
        <div className={styles.opinions}>
          <img className={styles.opinionsChild} alt="" src="../star-1.svg" />
          <img className={styles.opinionsItem} alt="" src="../star-1.svg" />
          <img className={styles.opinionsInner} alt="" src="../star-1.svg" />
          <img className={styles.starIcon} alt="" src="../star-1.svg" />
          <img className={styles.opinionsChild1} alt="" src="../star-1.svg" />
          <div className={styles.usersOpinion}>
            <p className={styles.fitness}>Users</p>
            <p className={styles.bunch}>opinion</p>
          </div>
        </div>
        <div className={styles.gym1}>
          <img
            className={styles.gymBaclgroundIcon}
            alt=""
            src="../1-gym-baclground@2x.png"
          />
          <Button
          ...
          <div className={styles.gymNo1Container}>
            <p className={styles.fitness}>GYM NO 1</p>
            <p className={styles.bunch}>Kraków</p>
          </div>
        </div>
      </div>
      {isLOGINPopupOpen && (
